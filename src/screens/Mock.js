...
import playersStd from '../assets/jsonDataManual_std.json';
import playersPpr from '../assets/jsonDataManual_ppr.json';
import playersHalf from '../assets/jsonDataManual_half.json';
